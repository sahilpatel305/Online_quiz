...
if(isset($submit))
{
	$rs=mysql_query("select login,pass,username from mst_user where login='$loginid' and pass='$pass'");
	$n=mysql_result($rs,0,1);
...
<p align="left" class="style5">&nbsp;</p>
    ...
    <td valign="top"><form name="form1" method="post" action="">
      <table width="200" border="0">
        ...
        <tr>
          <td colspan="2" bgcolor="#CC3300"><div align="center"><span class="style4">New User ? <a href="signup.php">Signup Free
		</span></div></td>
          </tr>
      </table>
      <div align="center">
